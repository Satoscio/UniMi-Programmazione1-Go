...
- una funzione `countdown` che fa scalare l'orario di un secondo, invocando opportunamente `updateMin` (vedi sotto) quando sono da modificare anche i minuti

- una funzione `updateMin` che fa scalare l'orario di un minuto, invocando opportunamente `updateHour` (vedi sotto) quando sono da modificare anche le ore
